...
public class AddFamilyUsingButtonTest {
	@Test
	public void addFamilyUsingButtonTest() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//label[.='Add Family']")).click();
		//Entering all the mandatory fields
				driver.findElement(By.name("Name")).sendKeys("New Member Name");
				driver.findElement(By.name("Spouse")).sendKeys("Spouse");
				driver.findElement(By.name("Location")).sendKeys("Location");
				driver.findElement(By.name("Birth Year")).sendKeys("1961");
				driver.findElement(By.name("Present Address")).sendKeys("Present Address");
				driver.findElement(By.name("Custom Label1")).sendKeys("Custom Label1");
				driver.findElement(By.name("Custom Label2")).sendKeys("Custom Label2");
				...
				driver.findElement(By.xpath("//button[@type='submit']")).click();
				Thread.sleep(2000);
				driver.findElement(By.xpath("//div[@id='root']/descendant::div[@class='tree']/child::div/ul/li/ul/descendant::div/p")).click();
				Thread.sleep(3000);
				driver.close();
	}
